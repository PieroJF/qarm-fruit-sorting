...
_STRAWBERRY_X_BIAS_M = -0.035     # empirical 2026-04-27: strawberry picks
                                   ...
                                   # -> -3.5cm in the same lab session.
                                   # Net effective x bias for strawberry
                                   # = +5cm - 3.5cm = +1.5cm. Banana /
                                   # tomato keep the full +5cm.
